...
const Responsive_Projects = [
  ...
  {
    pc_screenshot: 'amazondesktop.jpeg',

    mobile_screenshot: 'amazonmobileview.jpeg',

    title: 'Ezyshop',

    clone: 'clone : Amazon',

    description: 'It is an e-commerce website selling vast range of products.',
    ...
    netlify: 'https://my-app-lake-iota.vercel.app/',

    github: 'https://github.com/NehaP0/splendid-quiver-7090/tree/main/my-app',
  ...
  {
    pc_screenshot: 'pctenous.png',

    mobile_screenshot: 'mobiletenous.png',

    title: 'tenuous-fruit-1942',

    clone: 'clone :ubronic ',

    description: 'It is a leading American e-commerce platform that specializes in fashion products.',

    tech_stack: [{ skill: 'HTML.png', w: '20px' }, { skill: 'CSS.png', w: '25px' }, { skill: 'Javascript.png', w: '25px' }],

    netlify: 'https://rainbow-stardust-b40b4e.netlify.app/',

    github: 'https://github.com/ravishukla21/tenuous-fruit-1942',



  },
  {
    pc_screenshot: 'pcshopcart.png',

    mobile_screenshot: 'phoneshopcart.png',

    title: ' actual-size-6883👗👖',

    clone: 'clone : Yours Daily Cart',

    description: 'This is a clone of template given to us.Shopcart is an e-commerce website which is made by a group of 5 members in a span of 5 days. The motive of making this was to practice and test our skills that we acquired as of now in Masai School.',

    tech_stack: [{ skill: 'HTML.png', w: '20px' }, { skill: 'CSS.png', w: '25px' }, { skill: 'Javascript.png', w: '25px' },],

    netlify: 'https://myapp-henna-two.vercel.app/',

    github: 'https://github.com/ravishukla21/actual-size-6883/tree/main/myapp',
...
const non_Responsive_Projects = [
  ...
  {
    pc_screenshot: 'yoursdailycart.png',

    mobile_screenshot: null,

    title: 'seemly-roof-9643 👗👖',
    ...
    netlify: 'https://enchanting-cendol-a0785b.netlify.app/',

    github: 'https://github.com/ravishukla21/seemly-roof-9643',
          ...
          {Responsive_Projects.map((el) => {
            return <GridItem key={Math.random()} className="project-card" bg='blue.700' px='10px' py='25px'>
              ...
              <Box flexDirection='column' display={{ base: 'flex', '1349px': 'none' }}>
                ...
                <Box m='auto' display='flex' flexDirection='column' w='100%' h='450px' bg='blue.800' borderRadius={'10px'} mt='20px' p='2'>
              ...
              <HStack mt={{ base: '20px', '1349px': '0px' }} flexDirection={{ base: 'column', '848px': 'row' }} justify={{ base: 'center', '1349px': '' }} position={'relative'}>
                ...
                <Image id={style['Project-scr']} top={{ 'base': '3.6%', '848px': '22%', '1349px': '16.4%' }} left={{ base: '15%', '371px': '13%', '496px': '14%', '848px': '23.2%', '1011px': '23.5%', '1349px': '5.1%' }} w={{ base: '70%', '848px': '31.9%' }} 
                h={{base:'25%','848px':'64.9%'}}
                position={'absolute'} src={el.pc_screenshot}></Image>
                ...
                <Image top={{ base: '40.5%', '296px': '40.3%', '358px': '40%', '363px': '39.6%', '468px': '39%', '555px': '38.5%', '631px': '38%', '848px': '2.5%' }} left={{ base: '26%', '468px': '27%', '848px': '64.5%', '1349px': '46.1%' }} w={{ base: '45%', '848px': '13.0%' }}
                 h={{base:'58%','848px':'90.9%'}}
                position={'absolute'} src={el.mobile_screenshot}></Image>
          ...
          {non_Responsive_Projects.map((el) => {
            ...
            return <GridItem key={Math.random()} className="project-card" bg='blue.700' px='10px' py='25px'>
              ...
              <HStack mt={{ base: '20px', '1349px': '0px' }} flexDirection={{ base: 'column', '848px': 'row' }} justify={{ base: 'center', '1349px': '' }} position={'relative'}>
                ...
                <Image id={style['Project-scr']} top={{ 'base': '10%', '848px': '10.5%', '1349px': '10.4%' }} left={{ base: '12%', '371px': '13%', '496px': '14%', '848px': '33.6%', '1011px': '33.8%', '1349px': '5.1%' }} w={{ base: '70%', '848px': '30.9%' }} h={{base:"70%","848px":"80.5%"} }position={'absolute'} src={el.pc_screenshot}></Image>
