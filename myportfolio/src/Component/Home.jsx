...
const Home = () => {
  ...
  const OpenPDF = () => {
    ...
    const url = `https://drive.google.com/file/d/1HAA67WXoT7UBAxERxif4m7xW_5ibD2eh/view`
    ...
    <Box  mt = '-90px' border = '2px solid rgb(1, 16, 27)' id = 'home' mb = '30px' >
      ...
      <HStack mt = {{base : '86px','456px' : '94px','612px' : '95px','735px' : '105px', '934px':'150px'}}  flexDirection={{base : 'column','934px' : 'row'}} pl = '25px' bg = 'blue.900' backdropFilter={'blur(10px)'}  justify={'space-between'} >
        ...
        <Box mb = {{base : '50px','934px' : 'none'}} pt = {{base : '30px','934px' : 'none'}} pr = {{base : '30px','934px' : 'none'}} w = {{base : '98%','934px' : '50%'}}  textAlign={'left'} >
            ...
            <Heading fontSize = '50px' id="user-detail-name"  color = 'rgb(0, 255, 162)' fontFamily={'monospace'} letterSpacing={'2px'}  as = 'h1'>Ravi Shukla</Heading>
            ...
            <HStack w = '170px' justify={'space-between'}>
                ...
                <Link  id="contact-phone" isExternal href = 'https://wa.me/+919773942736'>  <Image _hover = {{cursor : 'pointer', transform:'scale(1.1)',transition : 'all 0.4s'}} w = '35px' src = 'whatsapp.png'></Image>  </Link>
          ...
          <Image className = "home-img" w ={{ base : '85%','401px' : '75%','457px' : '60%','697px' : '50%','798px' : '40%','934px' : '30%'}} borderRadius={"70%"} src = 'Ravi_pic.jpg'></Image>
